...
export const signin = async (req, res) => {
    ...
    try {
        ...
        res.status(200).json({ result: {id: existingUser._id, email: existingUser.email, name: existingUser.name, username: existingUser.username, photo: existingUser.photo}, token });
    } catch (error) {
