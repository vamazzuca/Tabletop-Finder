...
exports.BggThingVideoDto = void 0;
...
__decorate([
    ...
    jackson_js_1.JsonAlias({ values: ["@_category"] })
], BggThingVideoDto.prototype, "category", void 0);
__decorate([
    jackson_js_1.JsonProperty(),
    jackson_js_1.JsonClassType({ type: () => [String] }),
    jackson_js_1.JsonAlias({ values: ["@_language"] })
], BggThingVideoDto.prototype, "language", void 0);
__decorate([
    jackson_js_1.JsonProperty(),
    jackson_js_1.JsonClassType({ type: () => [String] }),
    jackson_js_1.JsonAlias({ values: ["@_link"] })
...
exports.BggThingVideoDto = BggThingVideoDto;
